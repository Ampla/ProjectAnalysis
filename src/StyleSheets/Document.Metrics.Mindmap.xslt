...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="Project">
    <xsl:element name="map">
      ...
      <xsl:element name="node">
        ...
        <xsl:attribute name="BACKGROUND_COLOR">#A0A0A0</xsl:attribute>
  ...
  <xsl:template name="addMetricsSources">
    ...
    <xsl:element name="node">
      ...
      <xsl:attribute name="BACKGROUND_COLOR">#9FA0A4</xsl:attribute>
      <xsl:attribute name="STYLE">bubble</xsl:attribute>
      -->
...
<!--  
   ...
   -->
    <xsl:for-each select="$locations">
      ...
      <xsl:element name="node">
        ...
        <xsl:attribute name="STYLE">bubble</xsl:attribute>
        <xsl:attribute name="COLOR">#000000</xsl:attribute>
        <xsl:attribute name="BACKGROUND_COLOR">#FFDD00</xsl:attribute>
        <xsl:attribute name="TEXT">
  ...
  <xsl:template name="addSources">
    ...
    <xsl:for-each select="$names">
      ...
      <xsl:element name="node">
        ...
        <xsl:attribute name="STYLE">bubble</xsl:attribute>
        <xsl:attribute name="COLOR">#ffffff</xsl:attribute>
        <xsl:attribute name="BACKGROUND_COLOR">#F4A100</xsl:attribute>
        <xsl:attribute name="TEXT">
        ...
        <xsl:for-each select="$sources">
          ...
          <xsl:element name="node">
            ...
            <xsl:attribute name="STYLE">bubble</xsl:attribute>
            <xsl:attribute name="COLOR">#ffffff</xsl:attribute>
            <xsl:attribute name="BACKGROUND_COLOR">#87d200</xsl:attribute>
  ...
  <xsl:template match="KpiLink">
    ...
    <xsl:element name="arrowlink">
      <xsl:attribute name="COLOR">#2FB4E9</xsl:attribute>
  ...
  <xsl:template match="ResolverLink">
    ...
    -->
    <xsl:element name="arrowlink">
      <xsl:attribute name="COLOR">#C4014B</xsl:attribute>
      <xsl:attribute name="DESTINATION">
        <xsl:value-of select="concat('resolver_',@id)"/>
      </xsl:attribute>
      <xsl:attribute name="ENDARROW">Default</xsl:attribute>
  ...
  <xsl:template match="Source">
    ...
    <xsl:element name="arrowlink">
      <xsl:attribute name="COLOR">#87D200</xsl:attribute>
      <xsl:attribute name="DESTINATION">
        <xsl:value-of select="concat('source_',@id)"/>
      </xsl:attribute>
      <xsl:attribute name="ENDARROW">Default</xsl:attribute>
