...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/Project">
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <h1 lang="" class="text">Ampla Equipment Summary</h1>
        <div id="layout-menu">
        ...
        <table>
          <tbody>
            <tr>
              <td>
                <xsl:apply-templates select="Item[@id and descendant::Item[Property[@name='EquipmentTypes']]]">
  ...
  <xsl:template match="Item[@id]">
    ...
    <xsl:variable name="items" select="Item[@id and descendant::Item[Property[@name='EquipmentTypes']]]"/>
    <xsl:variable name="desc-items" select="descendant::Item[@id and descendant::Item[Property[@name='EquipmentTypes']]]"/>
